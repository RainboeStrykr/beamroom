...
import desktop from "@/app/assets/Beamroom(tutorial).gif";
import Link from "next/link";

const steps = [
  {
    title: "Create a Room",
    description: "A random code will be generated for you.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Enter the code after clicking 'Join Room' or just open the shareable link",
  },
];
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="lg:w-1/2 lg:pl-12">
            ...
            <Button size="lg" className="mt-6" asChild>
              <Link href={"https://github.com/RainboeStrykr/beamroom"}>Github Repo</Link>
            </Button>
          </div>
        </div>
      </div>
